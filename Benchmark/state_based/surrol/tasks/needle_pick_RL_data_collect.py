...
from surrol.tasks.psm_env_RL import PsmEnv
...
class NeedlePickRL(PsmEnv):
    ...
    def get_oracle_action(self, obs) -> np.ndarray:
        ...
        if not os.path.exists(f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/needlepick/{env_setup_counter}'):
            # Create the directory
            os.makedirs(f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/needlepick/{env_setup_counter}')
        ...
        torch.save(self.observation_info, f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/needlepick/{env_setup_counter}/observation.pth')
        torch.save(self.goal_info, f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/needlepick/{env_setup_counter}/goal.pth')
        torch.save(self.action_info, f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/needlepick/{env_setup_counter}/action.pth')
