...
class BiPegBoardFullDof(PsmsEnv):
    ...
    POSE_BOARD = ((0.52, 0, 0.6861), (0, 0, 0))  # 0.675 + 0.011 + 0.001
    ...
    def __init__(self, render_mode=None, cid = -1):
        super(BiPegBoardFullDof, self).__init__(render_mode, cid)
    ...
    def _env_setup(self):
        super(BiPegBoardFullDof, self)._env_setup()
...
if __name__ == "__main__":
    ...
    env = BiPegBoardFullDof(render_mode='human')  # create one process and corresponding env
