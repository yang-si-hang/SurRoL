...
class PickAndPlace(PsmEnv):
    ...
    def _env_setup(self):
        ...
        pos_1_x, pos_1_y, pos_2_x, pos_2_y = 2.701589021587866, -0.025616336335973967, 2.7923015710221013, 0.024151722524886524
    ...
    def get_oracle_action(self, obs) -> np.ndarray:
        ...
        if not os.path.exists(f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/pickandplacenew/{env_setup_counter}'):
            # Create the directory
            os.makedirs(f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/pickandplacenew/{env_setup_counter}')

        self.observation_info[self.counter] = obs['observation']
        self.goal_info[self.counter] = obs['desired_goal']
        self.action_info[self.counter] = action
        torch.save(self.observation_info, f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/pickandplacenew/{env_setup_counter}/observation.pth')
        torch.save(self.goal_info, f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/pickandplacenew/{env_setup_counter}/goal.pth')
        torch.save(self.action_info, f'/research/d1/gds/jwfu/SurRoL_science_robotics_experiment_state_based/experiment_data/pickandplacenew/{env_setup_counter}/action.pth')
