...
class MatchBoardFullDof(PsmEnv):
    ...
    BOARD_ORN= (1.57,0,0)
    BOARD_SCALING = 0.03
    WORKSPACE_LIMITS = ((0.45, 0.65), (-0.07, 0.07), (0.685, 0.745))  # reduce tip pad contact
    SCALING = 5.
    ...
    def __init__(self, render_mode=None, cid = -1):
        super(MatchBoardFullDof, self).__init__(render_mode, cid, plot=False)
    ...
    def _env_setup(self):
        super(MatchBoardFullDof, self)._env_setup()
...
if __name__ == "__main__":
    env = MatchBoardFullDof(render_mode='human')  # create one process and corresponding env
