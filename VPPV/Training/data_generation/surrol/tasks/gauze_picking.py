...
class GauzePick(PsmEnv):
    ...
    def _get_obs(self) -> dict:
        ...
        observation = np.concatenate([
            ...
            waypoint_pos.ravel(), waypoint_rot.ravel(), #self.goal  # achieved_goal.copy(),
        ])
        ...
        #plt.imsave('/home/student/code/regress_data_gauze_newcam/seg/seg_{}.png'.format(self.counter),seg)
        #plt.imsave('/home/student/code/regress_data_gauze_newcam/d/d_{}.png'.format(self.counter),depth)
        #cv2.imwrite('/home/student/code/regress_data_gauze_newcam/img/img_{}.png'.format(self.counter),cv2.cvtColor(render_obs, cv2.COLOR_BGR2RGB))
        np.save('/home/yhlong/project/VPPV_checking/data/gauze/seg_npy/seg_{}.npy'.format(self.counter),seg)
        np.save('/home/yhlong/project/VPPV_checking/data/gauze/depth/depth_{}.npy'.format(self.counter),depth)
        ...
        #self.img_list[self.counter]['tg_goal']=obs['desired_goal']
        
        #self.img_list[self.counter]=obs['observation']


        if self.counter>=20001:
            with open('/home/yhlong/project/VPPV_checking/data/gauze/img_obs.pkl',"wb") as f:
