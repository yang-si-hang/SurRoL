...
sys.path.append('/research/dept7/yhlong/Science_Robotics/stateregress_back')
...
class TissueApproach(PsmEnv):
    ...
    def __init__(self, render_mode='human'):
        super(TissueApproach, self).__init__(render_mode)
