...
from rl.utils.general_utils import AttrDict
from .ddpgbc import DDPGBC
from rl.modules.visual_obs import VisProcess, VisRes
from rl.components.normalizer import Normalizer
...
class VisDEX(DDPGBC):
    def __init__(
        ...
        #super().__init__(env_params, agent_cfg)
    ...
    def get_samples(self, replay_buffer,depth_noise=False):
        ...
        '''
        depth_norm=self.depth_norm.normalize(depth.reshape(-1,256*256)).reshape(-1,1,256,256)
