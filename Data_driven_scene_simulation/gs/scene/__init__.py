...
class Scene:
    ...
    def __init__(
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["LLFF"](
                args.source_path, args.images, args.eval
            )  # Change "Colmap" to "LLFF"
        ...
        self.cameras_extent = scene_info.nerf_normalization[
            "radius"
        ]  # for endo-nerf dataset, this value is zero because of the fixed camera
